...
$(function(){
      ...
      $("form").submit(function(){
        ...
        $('form').append("<input type='hidden' name='reviewNum' value='${param.reviewNum}'>")
      if(count>0)
            $('form').submit();
      else{
...
<form action="updatereview.do" method="post" name="frm"> <!--  enctype="multipart/form-data" -->
...
<table class="colorborder" border="1" align="center" width="80%" style="table-layout:fixed;">
   ...
   <tr>
      ...
      <td width="80px" colspan="4"><input type="text" name="title" required="required" value="${rvo.title}" style="width:99%;"></td>
   </tr>
   <tr>
   ...
   <tr>
      <td colspan="4"><textarea id="smarteditor" rows="30" cols="40" name="smarteditor" style="width:99%;">${updateContent}</textarea></td>
      <td>
