...
#header {
	...
	-moz-border-imag: -moz-linear-gradient(left, #2196F3, #2196F3);
	/* #CEF6EC #A4A4A4 #BDBDBD #AEB404*/
	-webkit-border-image: -webkit-linear-gradient(left, #2196F3, #2196F3);
	border-image: linear-gradient(to right, #2196F3, #2196F3);
