		...
		<c:when test="${flag == true}">
			<c:forEach items="${mcourse.list}" var="mList">
				<div align="center" class="col-sm-12">
					<a
						href="detailCourse.do?courseNum=${mList.courseNum}&&courseName=${mList.courseName}"><h4
							style="margin-left: 100px; margin-top: 20px" align="left">${mList.courseName}</h4></a><br>
					<div class="courseDiv"
						style="border-bottom: 1px solid lightgray; margin-bottom: 40px">
						<br>
						<c:forEach items="${mList.map}" var="entry" varStatus="status">
			...
			<div align="center" class="col-sm-12">
				...
				<c:if test="${pb.previousPageGroup}">
					<ul class="pagination pagination-sm">
						<li><a
							href="myCourse.do?id=${vo.id}&&pageNo=${pb.startPageOfPageGroup-1}">&#60;</a></li>
					</ul>
				</c:if>
               ...
               &nbsp;
				...
				<c:if test="${pb.nextPageGroup}">
					<ul class="pagination pagination-sm">
						<li><a
							href="myCourse.do?id=${vo.id}&&pageNo=${pb.endPageOfPageGroup+1}">&#62;</a></li>
					</ul>
				</c:if>
			</div>
		</c:when>
